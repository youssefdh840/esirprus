...
// --- Constants ---
const CORRECT_BIRTHDAY = "2008-03-20";
const PERSONALITY_TRAITS = [
  "Beautiful", "Smart", "Funny", "Kind", "Strong", "Intellectual", "Feeling bored"
];
    ...
    >
      ...
      <div className="flex justify-center">
        ...
        <motion.div 
          ...
          className="max-w-2xl w-full bg-zinc-900 rounded-3xl border border-white/10 overflow-hidden shadow-2xl"
        >
          <img 
            src="https://raw.githubusercontent.com/youssefdh840/esirprus/main/Public/Screenshot_2026-03-19-12-52-51-914_com.android.chrome.png" 
            alt="Memories" 
            className="w-full h-auto object-cover"
            referrerPolicy="no-referrer"
          />
          <div className="p-6 text-center">
            <h3 className="text-white font-medium mb-1 text-lg">Memories Gallery</h3>
            <p className="text-zinc-500 text-sm italic">A collection of our favorite moments together.</p>
          </div>
        </motion.div>
      </div>
